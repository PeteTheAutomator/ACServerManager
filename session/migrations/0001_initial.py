    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The name of the preset - this combined with your server-setting name will appear in the Assetto Corsa server listing', max_length=64)),
